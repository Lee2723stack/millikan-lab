...
const Nav = {
  ...
  render() {
    ...
    if (isAdmin) {
      tabsEl.innerHTML = `
        <button class="nav-tab ${this.currentView === 'upload' ? 'active' : ''}" data-view="upload">📤 上传数据</button>
        <button class="nav-tab ${this.currentView === 'myData' ? 'active' : ''}" data-view="myData">📋 我的数据</button>
        <button class="nav-tab ${this.currentView === 'stats' ? 'active' : ''}" data-view="stats">📊 统计分析</button>
        <button class="nav-tab ${this.currentView === 'millikan' ? 'active' : ''}" data-view="millikan">🔬 实验计算</button>
        <button class="nav-tab ${this.currentView === 'allData' ? 'active' : ''}" data-view="allData">👥 全部数据</button>
        <button class="nav-tab ${this.currentView === 'users' ? 'active' : ''}" data-view="users">👤 用户管理</button>
      `;
    } else {
      tabsEl.innerHTML = `
        <button class="nav-tab ${this.currentView === 'upload' ? 'active' : ''}" data-view="upload">📤 上传数据</button>
